...
public class LinkedListDemo {
	...
	public static void main(String[] args) {
        ...
        LinkedList<String> friends = new LinkedList<>(); //here it is not mandatory to again mention the wrapper class
        ...
        System.out.println("************ Retrieve Elements from LL**************");
        System.out.println("First Friend in a list :"+friends.getFirst());
        System.out.println("First Friend in a list :"+friends.getLast());
        ...
        System.out.println("Position of John in a LL :"+friends.indexOf("John"));
